...
namespace RoadBook.CsharpBasic.Chapter03.Examples
{
    internal class Ex008
    {
        public void Run()
        {
            ...
            if (number > 0 && isOddNumber) // true and true
            {
                Console.WriteLine("{0}은 양의 홀수입니다.", number);
            }

            else if (number > 0 && !isOddNumber) //true and not true
            {
                Console.WriteLine("{0}은 양의 짝수입니다.", number);
            }

            else if (number < 0 && isOddNumber) //true and true
            {
                Console.WriteLine("{0}은 음의 홀수입니다", number);
            }

            else if (number < 0 && isOddNumber) //true and not truetrue
            {
